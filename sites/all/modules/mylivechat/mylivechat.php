...
class mylivechat
{
  ...
  public function getChatCode()
  {
	...
	{
		$chat_button .= "<script type=\"text/javascript\" async=\"async\" defer=\"defer\" data-cfasync=\"false\" src=\"https://www.mylivechat.com/chatinline.aspx?hccid=".$mylivechat_id."\"></script>";
	}
	...
	{
		$chat_button .= "<script type=\"text/javascript\" async=\"async\" defer=\"defer\" data-cfasync=\"false\" src=\"https://www.mylivechat.com/chatwidget.aspx?hccid=".$mylivechat_id."\"></script>";
	}
	else
	{
